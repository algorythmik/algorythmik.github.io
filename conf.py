...
BLOG_AUTHOR = "Mojtaba Tabatabaeiporu"  # (translatable)
BLOG_TITLE = "Notes to self"  # (translatable)
...
BLOG_EMAIL = "smt.moji@gmail.com"
BLOG_DESCRIPTION = "Notes to myself"  # (translatable)
